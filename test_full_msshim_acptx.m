...
n_reg_vals = 12; % formerly 15
%lamda_v = logspace(-1, 1, n_reg_vals)*4;% works ok but overregularizes SAR
% lamda_v = logspace(-1, 2, 8 );

%lamda_v = logspace(-3, -1, n_reg_vals);
lamda_v = logspace(-2, 0, n_reg_vals);
%lamda_v = logspace(-3, -1, n_reg_vals);
